  ...
  return (
    <>
...

      {
        ...
        <div className="border rounded mt-2 p-2 m-4 ms-5" droppable="true" onDragOver={e=>dragOver(e)}  onDrop={e=>videoDrop(e,category.id)}>
       <div  className=".d-flex justify-content-between align-items-center">
        <h3>{category.categoryName}</h3>
        <button onClick={()=>removeCategory(category.id)} className="btn"><i class="fa-solid fa-trash-can"></i></button>
